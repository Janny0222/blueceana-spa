    ...
    <Page>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 lg:grid-cols-2">
          <SectionReveal>
            <div className="overflow-hidden rounded-[2rem] shadow-xl shadow-ocean-900/10 ring-1 ring-ocean-100">
              <img
          ...
          <SectionReveal delay={0.1}>
            ...
            <h2 className="mt-3 font-display text-3xl font-bold text-ocean-900">
              Where Relaxation Meets Care
            </h2>
            <p className="mt-5 leading-relaxed text-ocean-800/75">
      ...
      <section className="bg-ocean-50 py-20">
        <div className="mx-auto max-w-6xl px-5">
          <SectionReveal className="mx-auto max-w-2xl text-center">
            <h2 className="font-display text-3xl font-bold text-ocean-900">
